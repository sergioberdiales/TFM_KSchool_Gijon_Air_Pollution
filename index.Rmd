...
* 1. __Project Memory__. From the "Preface" to the "References" section would be the memory of the project. The purpose of this section is to explain in a few words what are the objectives of this project, which methodology I used in order to achieve these objectives, and what are my final conclusions. 

* 2. __R and Python code__. After this first section I included all the R code used (this R code is saved too as rmarkdown files in the Github project repository).  
