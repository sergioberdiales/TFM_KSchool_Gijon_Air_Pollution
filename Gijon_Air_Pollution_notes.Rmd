...
# In order to add a new variable with more conveniente station names we create a dictionary with an alias for each station
...
# We join the alias dictionary to the air_data_1 dataframe
