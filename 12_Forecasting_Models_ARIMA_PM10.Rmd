...
```{r  h1_grid_graphs, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
```{r h1_y_test_y_pred_graph, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
```{r h1_residuals_distribution_graph, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
monthly_mae_9y_2 <- monthly_mae_9y %>%
                    select('month(date_time_utc)',
                            mae) %>%
                    unique() %>%
                    rename(month = 'month(date_time_utc)',
...
monthly_mae_base_model_vs_arima3m_3y_9y_graph 
...
```{r  h6_grid_graphs_2, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
```{r h12_grid_graphs, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
```{r  h24_grid_graphs, warning = FALSE, message= FALSE, out.width= '\\textwidth'}
