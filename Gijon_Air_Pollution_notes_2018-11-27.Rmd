...
It doesn't seem like the Arima model is working very well. Maybe we should have to take a shorter period for the training data

```{r warning = FALSE, message= FALSE, out.width= '\\textwidth'}

model_arima_2=auto.arima(train_pm10_2_ts,seasonal=TRUE,trace=TRUE)
plot(forecast(model_arima_2,h=24))
summary(model_arima_2)

test_pm10$Arima_2=forecast(model_arima_2,h=12)$mean
