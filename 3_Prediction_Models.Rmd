...
### Base model. 
As a base model we are going to take as prediction the value from the previous hour.
...
And the standard deviation of the test data is 10.9, which is greater than the RMSE (7.45). So, this estimation is better than using the mean.
```{r warning = FALSE, message= FALSE, out.width= '\\textwidth'}
...
autoplot(test_201701_201709)
autoplot(validation_201710_201712)
